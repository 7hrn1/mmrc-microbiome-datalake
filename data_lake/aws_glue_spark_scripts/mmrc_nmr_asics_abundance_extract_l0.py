...
bucket_name = "mmrc-nmr-asics-abundance"
...
table_name = "mmrc_nmr_asics_abundance_sam"
full_table_name = f"""{catalog_name}.{database_name}.{table_name}"""

#Configure tax table details
catalog_name_t = "glue_catalog_t"
table_name_t = "mmrc_nmr_asics_abundance_tax"
...
def main():
    ...
    try:
        ...
        nmr_abund_dyf = glueContext.create_dynamic_frame.from_options(
            format_options={
                "withHeader": True
            },
            connection_type="s3",
        ...
        nmr_abund_df = nmr_abund_dyf.toDF()
        
        #1. Extract 4-digit sample number and standardise format to be SampleXXXX
        sample_id_col_header = nmr_abund_df.schema[0].name
        cleaned_sample_id_df = nmr_abund_df.withColumn(
            "Sample_ID_Extracted", 
