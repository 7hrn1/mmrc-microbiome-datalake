...
bucket_name = "mmrc-bacterial-pathway"
...
table_name = "mmrc_bacterial_pathway_sam"
full_table_name = f"""{catalog_name}.{database_name}.{table_name}"""

#Configure tax table details
catalog_name_t = "glue_catalog_t"
table_name_t = "mmrc_bacterial_pathway_tax"
...
def main():
    ...
    try:
        ...
        bac_path_dyf = glueContext.create_dynamic_frame.from_options(
            format_options={
                "withHeader": True
            },
            connection_type="s3",
        ...
        bac_path_df = bac_path_dyf.toDF()
        
        #1. Extract 4-digit sample number and standardise format to be SampleXXXX
        sample_id_col_header = bac_path_df.schema[0].name
        cleaned_sample_id_df = bac_path_df.withColumn(
            "Sample_ID_Extracted", 
